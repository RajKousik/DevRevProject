        ...
        <div className="item">
          ...
          <div className="user">
            <div className="userInfo">
              ...
              />
              <p>
                <span>Raj</span> changed their cover picture
              </p>
            </div>
            <span>1 min ago</span>
          </div>
          <div className="user">
            <div className="userInfo">
              ...
              />
              <p>
                <span>RK</span> changed their cover picture
              </p>
            </div>
            <span>1 min ago</span>
          </div>
          <div className="user">
            <div className="userInfo">
              ...
              />
              <p>
                <span>Emilia</span> changed their cover picture
              </p>
            </div>
            <span>1 min ago</span>
          </div>
          <div className="user">
            <div className="userInfo">
              ...
              />
              <p>
                <span>Clarke Doe</span> changed their cover picture
              </p>
            </div>
            <span>1 min ago</span>
          </div>
